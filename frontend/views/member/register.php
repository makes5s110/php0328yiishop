...
<head>
    ...
    <link rel="stylesheet" href="<?php Yii::getAlias('@web')?>/style/login.css" type="text/css">
...
<div class="header w990 bc mt15">
    <div class="logo w990">
        <h2 class="fl"><a href="index.html"><img src="<?php Yii::getAlias('@web')?>/images/logo.png" alt="京西商城"></a></h2>
    </div>
</div>
<!-- 页面头部 end -->
    ...
    $(".login_btn").click(function(){
        ...
        $.post('/member/ajax-register',$("#login_form").serialize(),function(data){
            ...
            if(json.status){
                alert('注册成功');
                //跳转到登录页
                window.location.href="/member/ajax-login";
            }else{
                //注册失败 显示错误信息
