...
<head>
    ...
    <link rel="stylesheet" href="<?php Yii::getAlias('@web')?>/style/list.css" type="text/css">
    ...
    <script type="text/javascript" src="<?php Yii::getAlias('@web')?>/js/list.js"></script>
</head>
<body>
<!-- 顶部导航 start -->
<div class="topnav">
        ...
        <div class="newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/list_hot1.jpg" alt="" /></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/list_hot2.jpg" alt="" /></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><img src="<?php Yii::getAlias('@web')?>/images/list_hot3.jpg" alt="" /></a></dt>
...
<!--                        --><?php //var_dump($models);exit;?>
                        <dt><a href="goods?id=<?=$res->id?>"><img src="<?=$res->logo?>" alt="" /></a></dt>
                        <dd><a href="goods?id=<?=$res->id?>"><?=$res->name?></a></dt>
                        <dd><strong>￥<?=$res->shop_price?></strong></dt>
...
<!--                <li>-->
<!--                    <dl>-->
<!--                        <dt><a href=""><img src="--><?php //Yii::getAlias('@web')?><!--/images/goods2.jpg" alt="" /></a></dt>-->
...
<!--                <li>-->
<!--                    <dl>-->
<!--                        <dt><a href=""><img src="--><?php //Yii::getAlias('@web')?><!--/images/goods3.jpg" alt="" /></a></dt>-->
...
<!--                <li>-->
<!--                    <dl>-->
<!--                        <dt><a href=""><img src="--><?php //Yii::getAlias('@web')?><!--/images/goods4.jpg" alt="" /></a></dt>-->
...
<!--                <li>-->
<!--                    <dl>-->
<!--                        <dt><a href=""><img src="--><?php //Yii::getAlias('@web')?><!--/images/goods5.jpg" alt="" /></a></dt>-->
...
<!--                <li>-->
<!--                    <dl>-->
<!--                        <dt><a href=""><img src="--><?php //Yii::getAlias('@web')?><!--/images/goods6.jpg" alt="" /></a></dt>-->
